...
- [x] T006 从旧 `agent-tools` 删除迁出的工作台/Profile Switcher 源码、确认的本机构建缓存和 12 个历史 Profile Switcher GitHub Release，提交并推送 `main`。
  映射：AC-006、AC-008。
